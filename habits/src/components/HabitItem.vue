...
const stopHabit = () => {
  ...
  // Set the stoppedDate to mark the habit as stopped
...
<template>
  <div v-if="isHabitVisible" class="habit-item">
    ...
    <!-- Include HabitTracker component for streak message -->
    <HabitTracker :habit="props.habit" :selectedDate="store.selectedDate" />
  </div>
</template>
